...
import java.util.*;
public class Tower_Of_Hanoi__pep_1 {
    public static void main(String[] args) throws Exception {
     ...
     public static void toh(int n, int t1, int t2, int t3){
        if(n==0)
            return;
        toh(n-1,t1,t3,t2); //will print the instruction to move n-1 disks from t1 to t3 using t2
        System.out.println(n+"["+t1+" -> "+t2+"]");
        toh(n-1,t3,t2,t1);  //will print the instruction to move n-1 disks from t3 to t3 using t1
    }
}
