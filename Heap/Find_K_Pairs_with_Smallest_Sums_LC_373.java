...
*/
import java.util.*;
public class Find_K_Pairs_with_Smallest_Sums_LC_373 {
    public static void main(String arg[]){
        /*  
            https://leetcode.com/problems/find-k-pairs-with-smallest-sums/submissions/639424693/?envType=list&envId=e9spcwu1
        */
    }
    class Solution {
        class Pair{
